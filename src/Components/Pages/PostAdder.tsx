...
export default function PostAdder(props:postAdderProps){
    ...
    const handleSubmit = (e) => {
        ...
        localPostsCopy.posts = localPostsCopy.posts.concat([{id:"", photoName: result.value.name, photoDescription: result.value.description, username: "aliHaitham", userProfilePic: "", likes: 0, image: result.value.pictureUrl, likedByUser: false}])
    ...
    return <>
    <Navbar />
    <form className="conatiner mt-5 pt-5" onSubmit={handleSubmit}>
